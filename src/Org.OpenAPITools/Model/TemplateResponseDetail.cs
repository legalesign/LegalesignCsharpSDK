...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TemplateResponseDetail :  IEquatable<TemplateResponseDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateResponseDetail" /> class.
        /// </summary>
        /// <param name="archive">archive.</param>
        /// <param name="created">created.</param>
        /// <param name="group">group.</param>
        /// <param name="hasFields">hasFields.</param>
        /// <param name="latestText">latestText.</param>
        ...
        public TemplateResponseDetail(bool archive = default(bool), DateTime created = default(DateTime), string group = default(string), bool hasFields = default(bool), string latestText = default(string), DateTime modified = default(DateTime), string resourceUri = default(string), int signeeCount = default(int), string title = default(string), string user = default(string), Guid uuid = default(Guid))
        {
        ...
        /// <summary>
        /// Gets or Sets LatestText
        /// </summary>
        [DataMember(Name="latest_text", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TemplateResponseDetail {\n");
        ...
        {
            return this.Equals(input as TemplateResponseDetail);
        }

        /// <summary>
        /// Returns true if TemplateResponseDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of TemplateResponseDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TemplateResponseDetail input)
        {
            if (input == null)
                return false;
