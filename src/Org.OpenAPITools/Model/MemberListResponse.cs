...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MemberListResponse :  IEquatable<MemberListResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MemberListResponse" /> class.
        /// </summary>
        /// <param name="meta">meta.</param>
        /// <param name="objects">objects.</param>
        public MemberListResponse(ListMeta meta = default(ListMeta), List<MemberResponse> objects = default(List<MemberResponse>))
        {
            this.Meta = meta;
        ...
        public List<MemberResponse> Objects { get; set; }
        ...
        {
            return this.Equals(input as MemberListResponse);
        }

        /// <summary>
        /// Returns true if MemberListResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of MemberListResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MemberListResponse input)
        {
            if (input == null)
                return false;
