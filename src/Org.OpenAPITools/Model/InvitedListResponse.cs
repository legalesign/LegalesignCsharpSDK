...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InvitedListResponse :  IEquatable<InvitedListResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvitedListResponse" /> class.
        /// </summary>
        /// <param name="meta">meta.</param>
        /// <param name="objects">objects.</param>
        public InvitedListResponse(ListMeta meta = default(ListMeta), List<InvitedListResponseObjects> objects = default(List<InvitedListResponseObjects>))
        {
            this.Meta = meta;
        ...
        public List<InvitedListResponseObjects> Objects { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InvitedListResponse {\n");
        ...
        {
            return this.Equals(input as InvitedListResponse);
        }

        /// <summary>
        /// Returns true if InvitedListResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of InvitedListResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvitedListResponse input)
        {
            if (input == null)
                return false;
