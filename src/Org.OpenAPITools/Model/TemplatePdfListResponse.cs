...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TemplatePdfListResponse :  IEquatable<TemplatePdfListResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplatePdfListResponse" /> class.
        /// </summary>
        /// <param name="meta">meta.</param>
        /// <param name="objects">objects.</param>
        public TemplatePdfListResponse(ListMeta meta = default(ListMeta), List<TemplatePdfResponse> objects = default(List<TemplatePdfResponse>))
        {
            this.Meta = meta;
        ...
        public List<TemplatePdfResponse> Objects { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TemplatePdfListResponse {\n");
        ...
        {
            return this.Equals(input as TemplatePdfListResponse);
        }

        /// <summary>
        /// Returns true if TemplatePdfListResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TemplatePdfListResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TemplatePdfListResponse input)
        {
            if (input == null)
                return false;
