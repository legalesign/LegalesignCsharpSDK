...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class TemplateListResponse :  IEquatable<TemplateListResponse>, IValidatableObject
    {
        ...
        public TemplateListResponse(ListMeta meta = default(ListMeta), List<TemplateResponse> objects = default(List<TemplateResponse>))
        {
            this.Meta = meta;
        ...
        public List<TemplateResponse> Objects { get; set; }
