...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GroupListResponse :  IEquatable<GroupListResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public GroupListResponse(ListMeta meta = default(ListMeta), List<GroupListResponseObjects> objects = default(List<GroupListResponseObjects>))
        {
            this.Meta = meta;
        ...
        public List<GroupListResponseObjects> Objects { get; set; }
        ...
        {
            return this.Equals(input as GroupListResponse);
        }

        /// <summary>
        /// Returns true if GroupListResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupListResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupListResponse input)
        {
            if (input == null)
                return false;
