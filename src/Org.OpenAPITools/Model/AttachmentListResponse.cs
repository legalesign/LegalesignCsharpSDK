...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AttachmentListResponse :  IEquatable<AttachmentListResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AttachmentListResponse" /> class.
        /// </summary>
        /// <param name="meta">meta.</param>
        /// <param name="objects">objects.</param>
        public AttachmentListResponse(ListMeta meta = default(ListMeta), List<AttachmentResponse> objects = default(List<AttachmentResponse>))
        {
            this.Meta = meta;
        ...
        public List<AttachmentResponse> Objects { get; set; }
        ...
        {
            return this.Equals(input as AttachmentListResponse);
        }

        /// <summary>
        /// Returns true if AttachmentListResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AttachmentListResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AttachmentListResponse input)
        {
            if (input == null)
                return false;
