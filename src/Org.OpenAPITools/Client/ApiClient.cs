...
namespace Org.OpenAPITools.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            ...
            RestClient = new RestClient("https://eu-api.legalesign.com/api/v1");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://eu-api.legalesign.com/api/v1).
        /// </summary>
        ...
        public ApiClient(String basePath = "https://eu-api.legalesign.com/api/v1")
        {
           if (String.IsNullOrEmpty(basePath))
                throw new ArgumentException("basePath cannot be empty");

            RestClient = new RestClient(basePath) { Authenticator = new HttpBasicAuthenticator("60d5cd89-0875-4dfe-b96b-f2780968007e", "a3e62652855b60ec53656132cd50e7d36dee82b6") };
        ...
        public object Deserialize(IRestResponse response, Type type)
        {
            ...
            if (type == typeof(InlineResponse201) ) // return primitive type
            {
                return new InlineResponse201(response.Content);
            }
